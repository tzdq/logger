...
#define ERROR_LOG_OPEN_FILE_FAILURE                 -1602   /* 打开日志文件出错 */
#define ERROR_LOG_MKDIR                               -1603   /* 日志目录创建失败 */
#define ERROR_LOG_PARAM_INVALID                      -1604   /* 日志参数非法 */
#define ERROR_LOG_NO_INIT                             -1605   /* 日志实例未成功初始化 */
#define ERROR_LOG_FILE_BACKUP_FAILURE               -1606   /*  日志备份失败 */
